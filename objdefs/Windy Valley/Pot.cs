...
namespace SADXObjectDefinitions.WindyValley
{
	...
	public class Pot01 : PotBase
	{
		...
		{
			model = ObjectHelper.LoadModel("Objects/Levels/Windy Valley/Pot01.sa1mdl");
	...
	public class Pot02 : PotBase
	{
		public override void Init(ObjectData data, string name)
		{
			model = ObjectHelper.LoadModel("Objects/Levels/Windy Valley/Pot02.sa1mdl");
			meshes = ObjectHelper.GetMeshes(model);
		}
	...
	public class BrPole : PotBase
	{
		public override void Init(ObjectData data, string name)
		{
			model = ObjectHelper.LoadModel("Objects/Levels/Windy Valley/BrPole.sa1mdl");
			meshes = ObjectHelper.GetMeshes(model);
		}
