...
namespace SADXObjectDefinitions.WindyValley
{
	...
	public class Raft2 : RaftBase
	{
		...
		{
			model = ObjectHelper.LoadModel("Objects/Levels/Windy Valley/Raft01.sa1mdl");
			meshes = ObjectHelper.GetMeshes(model);
			destModel = ObjectHelper.LoadModel("Objects/Levels/Windy Valley/Raft01.sa1mdl");
	...
	public class Raft3 : RaftBase
	{
		public override void Init(ObjectData data, string name)
		{
			model = ObjectHelper.LoadModel("Objects/Levels/Windy Valley/Raft02.sa1mdl");
			meshes = ObjectHelper.GetMeshes(model);
			destModel = ObjectHelper.LoadModel("Objects/Levels/Windy Valley/Raft02.sa1mdl");
			destMesh = ObjectHelper.GetMeshes(destModel);
		}
	...
	public class TRaft1 : RaftBase
	{
		public override void Init(ObjectData data, string name)
		{
			model = ObjectHelper.LoadModel("Objects/Levels/Windy Valley/TRaft1.sa1mdl");
			meshes = ObjectHelper.GetMeshes(model);
			destModel = ObjectHelper.LoadModel("Objects/Levels/Windy Valley/TRaft1.sa1mdl");
			destMesh = ObjectHelper.GetMeshes(destModel);
		}
	...
	public class TRaft2 : RaftBase
	{
		public override void Init(ObjectData data, string name)
		{
			model = ObjectHelper.LoadModel("Objects/Levels/Windy Valley/TRaft2.sa1mdl");
			meshes = ObjectHelper.GetMeshes(model);
			destModel = ObjectHelper.LoadModel("Objects/Levels/Windy Valley/TRaft2.sa1mdl");
			destMesh = ObjectHelper.GetMeshes(destModel);
		}
