...
namespace SADXObjectDefinitions.WindyValley
{
	public class WeleObj : ObjectDefinition
	{
		...
		{
			Wele1 = ObjectHelper.LoadModel("Objects/Levels/Windy Valley/Wele.sa1mdl");
			Wele1Msh = ObjectHelper.GetMeshes(Wele1);
			WeleWhite = ObjectHelper.LoadModel("Objects/Levels/Windy Valley/Wele_White.sa1mdl");
			WeleWhiteMsh = ObjectHelper.GetMeshes(WeleWhite);
			WeleAlt = ObjectHelper.LoadModel("Objects/Levels/Windy Valley/Wele_Alt.sa1mdl");
			WeleAltMsh = ObjectHelper.GetMeshes(WeleAlt);

			destWele = ObjectHelper.LoadModel("Objects/Levels/Windy Valley/Wele.sa1mdl");
